	...
	var GridTitle = React.createClass({
	    ...
	    render: function () {
	        ...
	        var nodes = this.props.columnSettings.getColumns().map(function (col, index) {
	            ...
	            var returnValue = null;
	            if (that.props.columnSettings.hasColumnMetadata() && typeof meta !== "undefined" && typeof meta.customHeaderComponent !== "undefined" && meta.customHeaderComponent !== null) {
	                var colData = React.createElement(meta.customHeaderComponent, { metadata: meta });
	                returnValue = React.createElement(
	                    "th",
	                    { className: columnSort, key: displayName, style: titleStyles },
	                    colData
	                );
	            }
